 ...
 * @author estudiantes
 */
public class Consignacion extends ManejadorTransaccion{
    ...
    public void realizarTransaccion(String transaccion) throws Exception {
         if ("2".equals(transaccion)) {
           ...
           if (caja == null) {
            ...
            this.setSucesor(new Transferencia());
    ...
    public void update(Observable o, Object arg) {
        try {
            ...
            Logger.getLogger(Consignacion.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
